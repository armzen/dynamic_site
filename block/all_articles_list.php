...
<!-- SHORT 1.SAMSUNG -->
	<div id="content">
		<h2 class="h2 col-md-12">Article 1. 1. Samsung Galaxy S7 edge.</h2>
		<div class="col-md-8 articles">  
			...
			<p>
			 ...
			 <a href="article_1.php?id=1" class="btn btn-primary" style="margin-bottom:48px"> REVIEW... </a>
		</div>
...
<!-- SHORT 2.GOOGLE PIXEL -->
	<div id="content">
		<h2 class="h2 col-md-12">Article 2. 2. Google Pixel.</h2>
		<div class="col-md-8 articles">
			<p>
				<strong>2) Content here.</strong>
			</p>
			<p>
			...
			<a href="article_2.php?id=2" class="btn btn-primary" style="margin-bottom:52px"> REVIEW... </a>
		</div>
		<div class="col-md-4 thumbnail">
			<img src="./images/googlePixel.jpg">
			<div class="caption">
				<p style="text-align:center">
...
<!-- SHORT 3.APPLE IPHONE 7 -->
	<div id="content">   
		<h2 class="h2 col-md-12">Article 3. 3. Apple iPhone 7.</h2>
		<div class="col-md-8 articles">      
			<p>
				<strong>3) Content here. </strong>
			</p>
			<p>
			...
			<a href="article_3.php?id=3" class="btn btn-primary" style="margin-bottom:48px"> REVIEW... </a>
		</div>
		
	   <div class="col-md-4 thumbnail">
			<img src="./images/appleIphone7.jpg" alt="">
			<div class="caption">
				<p style="text-align:center">
...
<!-- SHORT 4.ONEPLUSE 3T. -->
	<div id="content">        
		<h2 class="h2 col-md-12">Article 4. 4. OnePlus 3T.</h2>
		<div class="col-md-8 articles">   
			<p>
				<strong>4) Content here. </strong>
			</p>
			<p>
			...
			<a href="article_4.php?id=4" class="btn btn-primary" style="margin-bottom:52px"> REVIEW... </a>
		</div>
			<div class="col-md-4 thumbnail">
				<img src="./images/onePlusT5.jpg" alt="">
				<div class="caption">
					<p style="text-align:center">
